...
class QuizInterFace:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=true_img, highlightthickness=0,command=self.press_correct)
        self.true_button.grid(row=2, column=0)

        false_img = PhotoImage(file="quizzler-app/images/false.png")
        self.false_button = Button(image=false_img, highlightthickness=0,command=self.press_wrong)
